...
class KBaseDataImport(object):
    ...
    def ver(self):
        resp = self._call('KBaseDataImport.ver',
                          [])
        return resp[0]

    def get_ncbi_genome_names(self):
        resp = self._call('KBaseDataImport.get_ncbi_genome_names',
                          [])
        return resp[0]

    def import_ncbi_genome(self, input):
        resp = self._call('KBaseDataImport.import_ncbi_genome',
                          [input])
        # nothing to return
